    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-3 md:grid-cols-12">
      <div className="md:col-span-7">
        ...
        {touched.title && errors.title ? (
          <p id="title-error" className="text-destructive mt-1 text-sm" role="alert" aria-live="polite">
            {errors.title}
          </p>
        ) : null}
      </div>
      ...
      <div className="md:col-span-3">
        ...
        {touched.due && errors.due ? (
          <p id="due-error" className="text-destructive mt-1 text-sm" role="alert" aria-live="polite">
            {errors.due}
          </p>
        ) : null}
      </div>
